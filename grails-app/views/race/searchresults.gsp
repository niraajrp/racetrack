            ...
            <g:each in="${raceInstanceList}">
                <tr>
                    ...
                    <td nowrap class="numericData">
                        <span class="lineItemValue">
                            <g:formatNumber number="${it.distance}" format="##0.0 km"/>
                        </span>
                    </td>
                    <td nowrap class="numericData">
                        <span class="lineItemValue">
                    ...
                    <td nowrap class="numericData">
                        <span class="lineItemValue">
                            <g:formatNumber number="${it.winnerPrizeAmount}" format="₹ ###,##0.00"/>
                        </span>
                    </td>
                    <td class="actionButtons">
                        <g:if test="${it.registrations?.size() < it.maxRunners}">
                            <span class="actionButton">
                                <g:link controller="registration" action="register" id="${it.id}">Register
                                </g:link>
                            </span>
                        </g:if>
